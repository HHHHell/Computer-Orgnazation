...
#endif
static const char *ng0 = "D:/ISE/Project4/ALU.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
...
LAB62:    if (*((unsigned int *)t146) < *((unsigned int *)t147))
        goto LAB60;
...
LAB70:    if (*((unsigned int *)t158) > 0)
        goto LAB71;

LAB72:    if (*((unsigned int *)t144) > 0)
        goto LAB73;

LAB74:    memcpy(t143, t167, 8);
...
LAB71:    xsi_vlog_unsigned_bit_combine(t143, 32, t162, 32, t167, 32);
    goto LAB75;

LAB73:    memcpy(t143, t162, 8);
    goto LAB75;
...
LAB12:    t33 = (t0 + 1048U);
    ...
    *((unsigned int *)t32) = (t40 & 2147483647U);
...
LAB19:    if (*((unsigned int *)t32) < *((unsigned int *)t42))
        goto LAB18;
...
extern void work_m_00000000001110679707_0886308060_init()
{
	static char *pe[] = {(void *)Cont_30_0,(void *)Cont_38_1,(void *)Cont_40_2};
	xsi_register_didat("work_m_00000000001110679707_0886308060", "isim/P4_test_isim_beh.exe.sim/work/m_00000000001110679707_0886308060.didat");
